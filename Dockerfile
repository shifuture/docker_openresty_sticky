...
RUN apk add --no-cache --virtual .build-deps \
    ...
    && cd /tmp \
    && curl -fSL https://codeload.github.com/bymaximus/nginx-sticky-module-ng/zip/refs/heads/master -o nginx-sticky-module-ng.zip \
    && unzip nginx-sticky-module-ng-master.zip \
    && curl -fSL https://codeload.github.com/yaoweibin/nginx_upstream_check_module/zip/refs/heads/master -o nginx_upstream_check_module.zip \
	...
	nginx_upstream_check_module.zip nginx_upstream_check_module \
	nginx-sticky-module-ng.zip nginx-sticky-module-ng \
    && apk del .build-deps \
